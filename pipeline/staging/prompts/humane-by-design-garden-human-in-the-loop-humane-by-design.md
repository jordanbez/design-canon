...
Source label to use: `Humane by Design - 2023-12-21`
...
# Human in the Loop | Humane by Design

- URL: https://humanebydesign.com/garden/human-in-the-loop/
...
- [Trust](https://humanebydesign.com/tags/trust)

We can build a stronger relationship between humans and machines by placing humans in the AI-decision loop and empowering them with the ability to steer the algorithms that shape their experiences.

What if social platforms enabled users to fine-tune the algorithm that feeds their experience?
